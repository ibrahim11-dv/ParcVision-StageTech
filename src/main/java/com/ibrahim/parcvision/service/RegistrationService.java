...
public class RegistrationService {
    ...
    public RegistrationService(AdminRepository adminRepository, EntrepriseRepository entrepriseRepository, UtilisateurRepository utilisateurRepository, PasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<?> registerEntreprise(
            @Valid RegistrationRequestDao registrationRequestDao,
